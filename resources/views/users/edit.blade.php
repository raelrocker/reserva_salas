        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Editar Seus Dados</div>
                    ...
                    <div class="panel-heading">Deletar Seu Usuário</div>
                    <div class="panel-body">
                        <h5 class="text-danger">ALERT: ao deletar seu usuário, todas as suas reservas serão removidas</h5>
                        <form action="{{ URL::route('users.destroy',Auth::user()->id) }}" method="POST" style="display: inline-block">
